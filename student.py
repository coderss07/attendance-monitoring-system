...
class Student:
    def __init__(self, root):
        ...
        img1 = img1.resize((1400, 900), Image.ANTIALIAS)
        ...
        img2 = img2.resize((1400, 100), Image.ANTIALIAS)
        ...
        img_left = img_left.resize((1400, 100), Image.ANTIALIAS)
        ...
        sem_box["values"] = ("Select", "semester-1", "semester-2", "semester-3", "semester-4", "semester-5", "semester-6", "semester-7", "semester-8")
        sem_box.current(0)
        ...
        img_right = img_right.resize((1400, 100), Image.ANTIALIAS)
    ...
    def generate_dataset(self):
        if self.var_dep.get() == "Select" or self.var_course.get() == "Select" or self.var_name.get() == "" or self.var_id.get() == "":
            ...
            try:
                ...
                messagebox.showerror("Error", "Data_set not captured...", parent = self.root)
